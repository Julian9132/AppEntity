...
namespace Evaluacion
{
    class gui
    {
        ...
        public static void logo()
        {
                ...
                Console.SetCursorPosition(3, 17); Console.Write("███████╗███████╗███╗   ██╗ █████╗ ");
                Console.SetCursorPosition(3, 18); Console.Write("██╔════╝██╔════╝████╗  ██║██╔══██╗");
                Console.SetCursorPosition(3, 19); Console.Write("███████╗█████╗  ██╔██╗ ██║███████║");
                Console.SetCursorPosition(3, 20); Console.Write("╚════██║██╔══╝  ██║╚██╗██║██╔══██║");
                Console.SetCursorPosition(3, 21); Console.Write("███████║███████╗██║ ╚████║██║  ██║");
                Console.SetCursorPosition(3, 22); Console.Write("╚══════╝╚══════╝╚═╝  ╚═══╝╚═╝  ╚═╝");
                Console.SetCursorPosition(3, 24); Console.Write("Centro de Gestion de Mercados, Logistica y Sistemas de la Informacion");
