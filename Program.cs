    ...
    class Program
    {
        ...
        { // ------ inicio del menu----
            ...
            do
            {
                ...
                Console.Clear();
                gui.Marco(1, 110, 10, 30);
                gui.BorrarLinea(40, 22, 80);
                gui.logo();
                gui.Marco(1, 110, 1, 8);
                Console.SetCursorPosition(2, 2); Console.Write("*** Menu Principal *** ");
                gui.Linea(40, 60, 10);
                Console.SetCursorPosition(4, 6); Console.Write("1. Insertar ");
                Console.SetCursorPosition(20, 6); Console.Write("2. Listar ");
                Console.SetCursorPosition(36, 6); Console.Write("3. Buscar ");
                Console.SetCursorPosition(52, 6); Console.Write("4. Eliminar ");
                Console.SetCursorPosition(68, 6); Console.Write("5. Editar  ");
                //Console.SetCursorPosition(84, 6); Console.Write("6. Guardar   ");
                Console.SetCursorPosition(84, 6); Console.Write("0. Salir");
                ...
                do
                {
                    ...
                    Console.SetCursorPosition(84, 3); Console.Write("Escoja Opcion: ");
        ...
        static void Menuimpr()
        {
            ...
            Console.SetCursorPosition(68, 6); Console.Write("5. Editar  ");
            Console.SetCursorPosition(84, 6); Console.Write("6. Guardar   ");
            Console.SetCursorPosition(100, 6); Console.Write("0. Salir");
        }
    }
}
